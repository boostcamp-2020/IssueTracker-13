...
export default function MilestoneListNav({ milestones }) {
  ...
  return (
    <Nav>
      <OpenClosedButton text='Open' imgPath={milestoneImgPath} count={openMilestonesCount}></OpenClosedButton>
      <OpenClosedButton text='Closed' imgPath={checkImgPath} count={closedMilestonesCount}></OpenClosedButton>
    </Nav>
  );
}
